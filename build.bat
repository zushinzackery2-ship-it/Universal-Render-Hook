...
for %%F in (
    ...
    "%SRC_DIR%\urh_dx12_hooks_install.cpp"
    "%SRC_DIR%\urh_dx12_hooks_present.cpp"
    "%SRC_DIR%\urh_dx12_hooks_present1.cpp"
    "%SRC_DIR%\urh_dx12_probe.cpp"
    "%SRC_DIR%\urh_dx12_resources.cpp"
    "%SRC_DIR%\urh_vulkan_bootstrap.cpp"
    "%SRC_DIR%\urh_vulkan_tracking.cpp"
    "%SRC_DIR%\urh_vulkan_tracking_helpers.cpp"
    "%SRC_DIR%\urh_vulkan_dispatch.cpp"
    "%SRC_DIR%\urh_vulkan_probe_helpers.cpp"
    "%SRC_DIR%\urh_vulkan_probe_thread.cpp"
